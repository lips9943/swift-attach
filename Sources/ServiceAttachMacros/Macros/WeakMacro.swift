...
public struct WeakMacro: BaseScopeMacro {
    ...
    public static func expansion(
        ...
        // 메인 오브젝트 타입을 선언
        guard let varName = args.first else { return [] }
        ...
        // when implementation argument exists
        if let implArg {
        ...
        let cleanVarName = Helper.removeDoubleQuotationMarks(varName)
